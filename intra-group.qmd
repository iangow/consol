...
This chapter focuses on these **intra-group transactions** and the accounting for them as part of preparing consolidated accounts.
...
![Picture](intragroup_loan.png){#fig-loan}